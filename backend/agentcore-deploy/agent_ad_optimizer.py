# Agent: 广告投放优化师 — with S3 skill auto-loading
import os
import sys
import time
import json
...
logger = logging.getLogger("ad_optimizer")
...
BASE_SYSTEM_PROMPT = '你是一位数字广告投放优化专家。你擅长Facebook、Google、TikTok等平台的广告投放策略，能够分析广告数据并提供优化建议。回答时请使用中文。'
RELEVANT_SKILLS = ['global-marketing', 'user-behavior-funnel']
