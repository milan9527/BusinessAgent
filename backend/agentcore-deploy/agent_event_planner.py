# Agent: 活动策划助手 — with S3 skill auto-loading
import os
import sys
import time
import json
...
BASE_SYSTEM_PROMPT = '你是一位游戏活动策划专家。你擅长设计游戏内活动、奖励机制和限时活动。请根据玩家画像和游戏类型提供创意方案。回答时请使用中文。'
RELEVANT_SKILLS = ['game-player-retention']
