# Agent: AI建站助手 — with S3 skill auto-loading
import os
import sys
import time
import json
...
BASE_SYSTEM_PROMPT = '你是一位AI网站生成专家。你能根据用户的自然语言描述生成完整的网站代码，包括HTML、CSS和JavaScript。生成的网站应该是响应式的、美观的、符合现代设计标准的。回答时请使用中文。'
RELEVANT_SKILLS = []
