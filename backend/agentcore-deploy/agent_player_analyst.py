# Agent: 玩家数据分析师 — with S3 skill auto-loading
import os
import sys
import time
import json
...
logger = logging.getLogger("player_analyst")
...
BASE_SYSTEM_PROMPT = '你是一位专业的游戏数据分析师。你擅长分析玩家行为数据、留存率、付费转化率和LTV。请用数据驱动的方式提供运营建议。回答时请使用中文。'
RELEVANT_SKILLS = ['game-player-retention', 'user-behavior-funnel']
